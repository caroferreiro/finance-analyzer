...
3. default fallback: `https://caroferreiro.github.io/finance-analyzer/`
...
```bash
PLAYWRIGHT_BASE_URL=https://caroferreiro.github.io/finance-analyzer/ npm --prefix web run verify:pages:light
```
